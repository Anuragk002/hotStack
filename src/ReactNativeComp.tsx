...
function ReactNativeComp(props) {
    ...
    const renderItem = ({item}) => {
        return (
            <TouchableOpacity onPress={()=>Linking.openURL(item.link)} style={{minHeight:80,justifyContent:'center',marginBottom:5,paddingVertical:10,paddingHorizontal:5,backgroundColor:'#4BC581'}}>
